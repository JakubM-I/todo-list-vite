        ...
        <div className="w-[50%]">  
            <div>            
                <span className="flex justify-end">
                    <Link to={`/${query ? `?szukaj=${query}` : ""}`} className="pr-1 p-[2px] mb-1 border border-primaryLightColor hover:border-solid hover:border-borderGray hover:bg-[#e2e8f052] rounded">
