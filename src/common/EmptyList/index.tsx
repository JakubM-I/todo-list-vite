import { closeErrorFetchExampleData, configFetchErrorState, configLoadingState, fetchExampleData } from "../../features/configuration/configurationSlice";
import { useAppDispatch, useAppSelector } from "../../hooks/reduxHooks";
import { EmptyListProps } from "../../types/types";

const EmptyList: React.FC<EmptyListProps> = ({ body }) => {
